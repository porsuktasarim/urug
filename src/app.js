...
const driveSettingsRouter = require('./routes/driveSettings.routes');
const siteSettingsRouter = require('./routes/siteSettings.routes');
...
app.use('/uploads', driveFileProxyRouter);
...
app.use('/ayarlar/drive', driveSettingsRouter);
app.use('/ayarlar/site', siteSettingsRouter);
